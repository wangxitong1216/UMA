...
namespace UMA.Examples
{
    ...
    //TODO if the user changes the size of the head to be really big we end up inside.
    //We need this to calculate its minimum distance based on the size of thecapsule collider (assuming this is correct
